We host some of the code on Solana Playground (https://beta.solpg.io/) for networking reasons. For reproducibilty, the code is available in this file.

lib.rs
``` rust
use anchor_lang::prelude::*;

declare_id!("YOUR_CODE");
